...
import ConareCChainConareCchainCchain from './conare/c-chain/conare.cchain.cchain'
...
export default { 
  ConareCChainConareCchainCchain: load(ConareCChainConareCchainCchain, 'conare.cchain.cchain'),
